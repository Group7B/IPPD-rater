...
describe('Users E2E Tests:', function () {
  ...
  describe('Signup Validation', function () {
    ...
    it('Should Successfully register new user', function () {
      ...
      // Click Submit button
      element(by.css('button[type="submit"]')).click();
      expect(browser.getCurrentUrl()).toEqual('http://localhost:3001/projects');
    });
    ...
    it('Should report Email already exists', function () {
      ...
      element(by.css('button[type=submit]')).click();
      // Password Error
      expect(element.all(by.css('strong')).get(0).getText()).toBe('11000 duplicate key error collection: 27017.users index: email already exists');
    });
    ...
    it('Should report Username already exists', function () {
      ...
      element(by.css('button[type=submit]')).click();
      // Password Error
      expect(element.all(by.css('strong')).get(0).getText()).toBe('11000 duplicate key error collection: 27017.users index: username already exists');
    });
  ...
  describe('Admin Validation', function () {
    ...
    it('Should not let a guest view the admin panel', function () {
      //Make sure user is signed out first
      signout();
      // Get admin page
    ...
    it('Should not let a non-admin user view the admin panel', function () {
      //Make sure user is signed out first
      signout();
      //Sign in
      browser.get('http://localhost:3001');
      ...
      browser.get('http://localhost:3001/admin/users');
      // Expect forbidden
      expect(element.all(by.css('h1')).get(0).getText()).toBe('Forbidden');
    });
  });
